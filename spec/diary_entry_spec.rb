...
describe DiaryEntry do
  ...
  describe "count_words method" do
    it "returns int of 4 when contents contains 4 words" do
  ...
  describe "count_words method" do
    it "returns int of 0 when contents is an empty string" do
  ...
  describe "reading_time() method" do
    it "returns 0 when wpm is > 0 and contents is an empty string" do
      entry = DiaryEntry.new("Title", "")
  ...
  describe "reading_time() method" do
    it "returns 1 when wpm is 200 and contents is 200 words" do
  ...
  describe "reading_time() method" do
    it "returns 1 when wpm is 200 and contents is 150 words" do
  ...
  describe "reading_time() method" do
    it "returns 10 when wpm is 200 and contents is 1950 words" do
      entry = DiaryEntry.new("Title", ("one " * 1950))
      expect(entry.reading_time(200)).to eq 10
    end
  end

  describe "reading_chunk(wpm, minutes) method" do
  ...
  describe "calling reading_chunk(wpm, minutes) method twice" do
  ...
  describe "calling reading_chunk(wpm, minutes) method thrice" do
    context "when contents is 350 words, wpm is 200, mins is 1" do
